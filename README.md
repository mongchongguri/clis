...
src-tauri/target/release/bundle/nsis/Clis_1.0.7_x64-setup.exe
src-tauri/target/release/bundle/msi/Clis_1.0.7_x64_en-US.msi
```

자동 업데이트 서명 파일도 같이 생성됩니다.

```text
src-tauri/target/release/bundle/nsis/Clis_1.0.7_x64-setup.exe.sig
src-tauri/target/release/bundle/msi/Clis_1.0.7_x64_en-US.msi.sig
```
